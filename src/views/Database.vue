...
<body>
    ...
    <div class="database">
        ...
        <p><button type="button" class="osnovnButton" @click="click()">Войти</button> <br></p>
            ...
            <table id="myTable" class="table tablesorter table-hover table-bordered table-striped table-light">
                ...
                <tbody>
                    <tr class="tableSize" v-for="user in users_slice" :key="user.id">
                        ...
                        <td v-show="ADMIN" class="align-middle" name="ID" id=user.salary>{{ user.salary }}</td>
        ...
        <div id="page">
            ...
            <table class="pagination_table">
                <tr>
                    <td class="pagination_table_lev">Количество строк
                        <select v-model="kolvo_lines" selected="selected_KOLVO_LINES" style="width: 80%;">
                    ...
                    <td class="pagination_table_prav" id="btn_page"></td>
                </tr>
            </table>

            <!-- <input v-for="n in 10" :key="n" type="radio" class="btn-check" name="options-outlined" id=n autocomplete="off" checked>
            <label v-for="n in 10" :key="n" class="btn btn-outline-primary" for=n>{{ n }}</label> -->

            <!-- <input type="radio" class="btn-check" name="options-outlined" id="page2" autocomplete="off">
                <label class="btn btn-outline-primary" for="page2">
                    <p></p>
                </label>

            <input type="radio" class="btn-check" name="options-outlined" id="page3" autocomplete="off">
            <label class="btn btn-outline-primary" for="page3">
                <p></p>
            </label> -->
...
export default class Home extends Vue {
    ...
    async mounted() {
        ...
        this.pagination()
        await this.create_btn_page()

        this.func_me_inf()
        // this.GetListJob()
        // var rates = ( < HTMLInputElement > document.getElementsByName('ID'));
        // var rates2 = document.getElementsByName('ID');
        // console.log(rates2)
    }
    ...
    async create_btn_page() {
        var page = document.getElementById("btn_page")
        ...
        for (let i = 1; i <= this.kolvo_pages; i++) {
            ...
            input.onclick = this.selected_page
    ...
    async selected_page() {
        for (let i = 1; i <= this.kolvo_pages; i++) {
            var id = "page" + i
            var checked_page = ( < HTMLInputElement > document.getElementById(id)).checked;
